...
final class RecordingSynchCommand extends Command
{
    protected $signature = 'recordings:sync-code';

    protected $description = 'Sync recordings code with format YYYYMMDDORE from DATA and ORE columns';
