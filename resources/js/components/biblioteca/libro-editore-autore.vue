...
export default {
  ...
  props: {
    ...
    apiBibliotecaAutoriEditori: {
      //api.biblioteca.editori
      type: String,
    },
    apiBibliotecaAutoriEditoriCreate: {
      //api.biblioteca.editori.create:  create a new editore
      type: String,
    },
    inputLabel: {
      type: String,
    ...
    inputNoptions: {
      //message to show whith no data
      type: String,
      default: "Nessun risultato ottenuto...",
    },
    modalTitle: {
      // string into button and modal modalTitle
      type: String,
      default: "Inserimento",
    },
    modalButton: {
    ...
    modalPlaceholder: {
      // placeholder in the input field of the modal
      type: String,
  ...
  data() {
    return {
      ...
      item: !_.isEmpty(this.selected)
        ? this.fromObjectsToValueLabels(this.selected)
        : [],
  ...
  methods: {
    getOptions(search, loading) {
      loading(true);
      axios
        .get(this.apiBibliotecaAutoriEditori, { params: { term: search } })
        .then((response) => {
    ...
    aggiungi: function () {
      axios
        .post(this.apiBibliotecaAutoriEditoriCreate, {
          nome: this.nome,
        })
        .then((response) => {
