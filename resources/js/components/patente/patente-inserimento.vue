<template id="categorie">
  <div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input
              type="text"
              class="form-control"
              v-bind:value="personaSelected.data_nascita"
              disabled
            />
          </div>
          <div class="col-md-6">
            ...
            <input
              type="text"
              class="form-control"
              v-bind:value="personaSelected.provincia_nascita"
              disabled
            />
          </div>
        </div>
        <!-- end first row in left colum-->
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input
              ...
              class="form-control"
              autocomplete="off"
              v-model="nuovaPatente.numero_patente"
              name="numero_patente"
              :disabled="disabledAll"
            />
          </div>
        </div>
        <!-- end third row in left colum-->
        <div class="row">
          <div class="form-group col-md-12">
            <label for="note">Note:</label>
            <textarea
              class="form-control"
              v-model="nuovaPatente.note"
              name="note"
              :disabled="disabledAll"
            ></textarea>
          </div>
        </div>
        <!-- end fouth row in left colum-->
        <div class="row">
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="card">
              ...
              <div class="card-body">
                <div
                  v-if="nuovaPatente.categorie.length === 0"
                ...
                <ul class="list-inline">
                  <li
                    ...
                    v-for="(cat, index) in nuovaPatente.categorie"
                  >
          ...
          <div class="col-md-7">
            <div class="card">
              ...
              <div class="card-body">
                <div
                  v-if="nuovaPatente.cqc.length === 0"
                  class="p-1 mb-2 bg-danger text-white"
                >
                  Nessun C.Q.C
                </div>
                ...
                <button
                  class="btn btn-warning mt-3"
                  @click="openAggiungiCQC"
                  :disabled="!areCheckedCD()"
                >
                  Aggiungi
                </button>
              </div>
        ...
        <div class="modal-container" @click.stop>
          ...
          <div class="modal-body">
            <div class="row">
              <div
                class="col-md-3"
                v-for="(categoria, index) in categoriePossibili"
              >
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
                    :value="categoria"
                    v-model="nuovaPatente.categorie"
                    id="defaultCheck1"
                  />
          ...
          <div class="modal-footer text-right">
            <a class="btn btn-success" href="#" role="button" @click="close"
              >OK</a
            >
          </div>
        </div>
    ...
    <transition name="modalPatente">
      <div
        class="modal-mask"
        @click="closeModalPatenteAggiunta"
        v-show="showModalPatenteAggiunta"
      >
        <div class="modal-container" @click.stop>
          <div class="modal-header">
          ...
          <div class="modal-footer text-right">
            <a
              v-bind:href="modalPatenteAggiunta.urlInserimento"
              class="btn btn-success"
              role="button"
              aria-pressed="true"
              >Aggiungi altra patente</a
            >
            <a
              v-bind:href="modalPatenteAggiunta.urlPatente"
              class="btn btn-warning"
              role="button"
              aria-pressed="true"
              >Visualizza patente inserita</a
            >
            <button class="btn btn-danger" @click="closeModalPatenteAggiunta">
              Esci
            </button>
          </div>
        </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      personaSelected: {
        // persona selezionata dal dropdown menu
        persona_id: null,
        nome: null,
        cognome: null,
        data_nascita: null,
      ...
      modalPatenteAggiunta: {
        // url mostrati nel modal di conferma aggiunta nuova patente
        urlInserimento: null,
        urlPatente: null,
      },
  ...
  created: function () {
    ...
    axios.get(this.apiPatenteCqc).then((response) => {
      ...
      this.cqcPossibili.forEach((cqc) => {
        // aggiunge la data_rilascio e data_scadenza agli oggetti cqc.
  ...
  computed: {
    ...
    disabledData_scadenza_patente: function () {
      var data = this.transformIntoDate(
        this.nuovaPatente.data_rilascio_patente,
        "YYYY-MM-DD",
      );
      return {
        to: data,
  ...
  methods: {
    getRilascio(search, loading) {
      loading(true);
      axios
        .get(this.apiPatenteRilascio, { params: { term: search } })
        .then((response) => {
    ...
    areCheckedCD() {
      return (
        _.some(this.nuovaPatente.categorie, { categoria: "C" }) ||
    ...
    changedPersonaSelected: function (persona) {
      ...
      } else this.resetPersona();
    },
    getPersonePatenti: function (search, loading) {
      loading = true;
      axios
        .get(this.apiPatentePersone, { params: { term: search } })
        .then((response) => {
    ...
    salvaNuovaPatente() {
      axios
        .post(this.apiPatenteCreate, this.nuovaPatente)
        .then((response) => {
          this.showAlert = true;
