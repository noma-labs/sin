              ...
              <div class="card-body">
                ...
                <div v-for="(cqc, index) in nuovaPatente.cqc">
                  ...
                  <span class="badge badge-success"
                    >{{ cqc.pivot.data_rilascio }}
                  </span>
                  <span class="badge badge-danger">{{
                    cqc.pivot.data_scadenza
                  }}</span>
                </div>
                <button class="btn btn-warning mt-3" @click="openAggiungiCQC">
                  Aggiungi
                </button>
              </div>
            </div>
    ...
    <transition name="modal">
      <div class="modal-mask" v-show="showModalAggiungiCQC">
        <div class="modal-container" @click.stop>
              ...
              <div class="col-md-3">
                <div class="form-check">
                  <input
                    ...
                    id="checkCQC"
                  />
                  <label class="form-check-label" for="checkCQC"
                    >{{ c.categoria }}
                  </label>
                </div>
              </div>
          ...
          <div class="modal-footer text-right">
            <button class="btn btn-danger" @click="closeModalAggiungiCqc">
              OK
            </button>
          </div>
        </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      nuovaPatente: {
        ...
        categorie: [
          // array delle categorie assegnate alla patente
          // id: null
          // categoria: null,
          // descrizione: null,
          // note: null,
  ...
  methods: {
    ...
    formatCQCDate() {
      this.nuovaPatente.cqc.forEach((cqc) => {
    ...
    salvaNuovaPatente() {
      ...
      axios
        .put(this.apiPatenteModifica, this.nuovaPatente)
        .then((response) => {
          this.showAlert = true;
