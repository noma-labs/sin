<template>
  <div>
    ...
    <div
      v-if="isNatoANomadelfia || isMinorenneAccolto || isMinorenneConFamiglia"
    ...
    >
      ...
      <div class="col-sm-6">
        <autocomplete
          ...
          name="famiglia_id"
          :url="this.apiNomadelfiaFamiglie"
        ></autocomplete>
      </div>
    </div>

    <div
      v-if="isMaggiorenneSingle || isMaggiorenneConFamiglia"
      class="form-group row"
    >
      <label class="col-form-label col-sm-6" for="gruppo"
        >Gruppo Familiare:</label
      >
      <div class="col-sm-6">
        <autocomplete
          placeholder="Inserisci Gruppo Familiare..."
          name="gruppo_id"
          :url="this.apiNomadelfiaGruppi"
        ></autocomplete>
      </div>
    </div>
  </div>
