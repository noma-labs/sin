...
<div class="row">
  <div class="col-md-12">
    <div class="alert alert-info">
      Etichette da stampare:<strong> {{App\ArchivioDocumenti\Models\ArchivioDocumento::TobePrinted()->count()}}</strong>
  ...
  <div class="col-md-8">
    <div class="row">
      <div class="col-md-12 my-2">
          ...
          <a class="btn btn-success"   href="{{route('libri.etichette.esporta')}}"  role="button">Esporta etichette </a>
          <form  class="float-right" id="formRemoveAll" action="{{route('archiviodocumenti.etichette.rimuovi')}}" method="post">
            {{method_field('DELETE')}}
            {{ csrf_field() }}
            ...
            @forelse ($libriTobePrinted as $libro)
                <tr>
                  ...
                  <td >
                    ...
                    {{method_field('DELETE')}}  
                    {{ csrf_field() }}
                      <button class="btn btn-danger" type="submit">Rimuovi etichetta </button>
                    </form>
                  </td>
                </tr>
            @empty
                <div class="alert alert-danger">
                    <strong>Nessuna ethichetta da stampare</strong>
                </div>
            @endforelse
          </tbody>
          </table>
  ...
  <div class="col-md-4">
      <div class="card border-info   mb-3">
        <div class="card-header">
          Aggiungi etichette da stampare
        </div>
        <div class="card-body">
