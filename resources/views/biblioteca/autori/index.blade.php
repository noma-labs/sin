...
<div class="my-page-title">
    ...
    <div class="mr-auto p-2"><span class="h1 text-center">Ricerca Autori </span></div>
...
<div class="row">
  <div class="col-md-8 offset-md-2 my-3">
    ...
    <form action="{{route('autori.ricerca')}}" method="get">
      {{ csrf_field() }}
      <autocomplete placeholder="Inserisci autore ..." name="idAutore" url={{route('api.biblioteca.autori')}}></autocomplete>
