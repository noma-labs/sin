      ...
      <div class="row">
        <div class="col-md-12 my-2">
          ...
          >
            @csrf
            @method("DELETE")
            <button class="btn btn-danger" form="formRemoveAll" type="submit">
      ...
      <div class="card border-info mb-3">
        ...
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">
            Inserisci l'intervallo delle collocazioni dei libri che vuoi
            aggiungere o rimuovere dalla stampa delle etichette.
          </h6>
          <form
            method="POST"
            class="form"
