  ...
  <div class="row mb-3">
    <div class="col-md-8">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-12">
          <label class="form-label" for="autore"> Classificazione </label>
      ...
      <div class="card card-info border-info">
        ...
        <div class="card-body">
          @forelse ($prestitiAttivi as $prestito)
            <p>
              Cliente:
              <strong> {{ $prestito->cliente->nominativo }} </strong>
            </p>
            <p>
              Data Inizio Prestito:
              <strong> {{ $prestito->data_inizio_prestito }} </strong>
            </p>
            <p>
              Data Fine Prestito:
              <strong> {{ $prestito->data_fine_prestito }} </strong>
            </p>
            <p>
              Bibliotecario:
              <strong> {{ $prestito->bibliotecario->nominativo }} </strong>
            </p>
          @empty
