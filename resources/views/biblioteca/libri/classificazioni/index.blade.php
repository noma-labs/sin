...
<div class="my-page-title">
    ...
    <div class="mr-auto p-2"><span class="h1 text-center">Gestione Classificazioni </span></div>
    <div class="p-2 text-right">
      <h5 class="m-1">
        {{App\Biblioteca\Models\Classificazione::count()}} </strong> Classificazioni
      </h5 >
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-8 offset-md-2">
    <a href="{{ route('classificazioni.create') }}" class="btn btn-success my-3">Aggiungi Classificazione</a>
  </div>
</div>
           ...
           <td>
             <div class="btn-toolbar" role="toolbar" aria-label="...">
                <div class="btn-group" role="group" aria-label="...">
                 <a href="{{ route('classificazioni.edit', $classificazione->id) }}" class="btn btn-info pull-left" >Modifica</a></div>
                <div class="btn-group" role="group" aria-label="...">
