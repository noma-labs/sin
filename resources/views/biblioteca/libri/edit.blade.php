...
<form method="POST" id="form-modifica" action="/biblioteca/libri/{{$libro->id}}/modifica">
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="xCollocazione" value="{{$libro->collocazione}}" type="text"
                               id="xCollocazione" placeholder="Inserisci Collocazione" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div>
                            <a class="btn btn-success" href="{{route('libro.collocazione',['idLibro' => $libro->id])}}"
                               role="button">Modifica Colloc.</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" name="xTitolo" type="text" value="{{$libro->titolo}}" id="xTitolo"
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="data_pubblicazione" id="dataPubblicazione"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="dimensione" placeholder="Esempio 23x45cm"
