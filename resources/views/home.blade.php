    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card text-center border-info mb-3">
                ...
                <div class="card-body">
                    ...
                    <a target="_blank" href="http://192.168.11.7:3000/d/z-qyiG1Mk/weather?orgId=1&from=now-6h&to=now"
        ...
        <div class="col-md-4">
            <div class="card text-center border-warning mb-3">
                ...
                <div class="card-body">
                    <p class="card-text">Pannello di controllo per la gestione degli utenti, permessi, backup e logs di
                        tutti i sitemi.</p>
