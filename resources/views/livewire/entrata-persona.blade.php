<div>
   <div class="form-group row">
    ...
    <div class="col-sm-6">
      <p class="font-weight-bold">{{ $persona->nome }} {{ $persona->cognome }}</p>
    </div>
  </div>
  ...
  <div class="row">
    <label for="fornascita" class="col-sm-6">Come è entrato in Nomadelfia?</label>
    <div class="col-sm-6">
  ...
  <div class="row my-3">
    ...
    <div class="col-sm-6">
        <input class="form-control" type="date" name="data_entrata"  wire:model="dataEntrata"/>
    </div>
  </div>
