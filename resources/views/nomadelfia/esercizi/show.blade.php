      ...
      <div class="card border-dark my-2">
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <label class="col-sm-6 fw-bold"> Es. Spirituale: </label>
                <div class="col-sm-6">{{ $esercizio->turno }}</div>
              </div>
              <div class="row">
                <label class="col-sm-6 fw-bold"> Responsabile: </label>
                <div class="col-sm-6">
            ...
            <div class="col-md-6">
              <div class="row">
                <label class="col-sm-6 fw-bold"> Data inzio: </label>
                <div class="col-sm-6">{{ $esercizio->data_inizio }}</div>
              </div>
              <div class="row">
                <label class="col-sm-6 fw-bold"> Data fine: </label>
    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-header">
          <h5>
            Donne
            <span class="badge bg-primary"> {{ count($persone->donne) }} </span>
          </h5>
        </div>
        <div class="card-body">
          <div class="row">
