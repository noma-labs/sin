    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          <p class="card-text">
            Nome famiglia:
            <span class="fw-bold"> {{ $famiglia->nome_famiglia }} </span>
          </p>
          <p class="card-text">
            Data creazione:
            <span class="fw-bold"> {{ $famiglia->data_creazione }} </span>
          </p>
          ...
          >
            <x-slot:body>
              ...
              >
                @csrf
                <p>
                  Inserire la data di uscita della famiglia {{ $famiglia->nome_famiglia }}
                </p>
          ...
          <div class="card mb-2">
            ...
            >
              <div class="card-body">
                @if ($gruppoAttuale)
                  <div class="row">
                    <div class="col-sm-6 fw-bold">Gruppo familiare</div>
                    <div class="col-sm-6 fw-bold">Data entrata</div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card mb-2">
            ...
            >
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6 fw-bold">Gruppo familiare</div>
                  <div class="col-md-6 fw-bold">Data entrata - data uscita</div>
                </div>
                  ...
                  @forelse ($gruppiStorici as $gruppo)
                    <li class="list-group-item">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <span>
                            {{ $gruppo->data_entrata_gruppo }} - {{ $gruppo->data_uscita_gruppo }}
                          </span>
                        </div>
                      </div>
                    </li>
