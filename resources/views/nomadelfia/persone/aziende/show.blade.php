      ...
      <div class="card">
        ...
        <div class="card-body">
                ...
                >
                  <x-slot:body>
                    ...
                    >
                      ...
                      <div class="row">
                        <label class="col-sm-6 form-label"> Mansione </label>
                        <div class="col-sm-6">
          ...
          >
            <x-slot:body>
              ...
              >
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <select name="azienda_id" class="form-select">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <select name="mansione" class="form-select">
                      ...
                      <option value="RESPONSABILE AZIENDA">
                        Responsabile azienda
                      </option>
                    </select>
                  </div>
            ...
            <x-slot:footer>
              <button class="btn btn-success" form="formPersonaAzinedaAggiungi">
                Salva
              </button>
            </x-slot:footer>
          </x-modal>
