                ...
                <div class="card-body">
                    @if ($attuale)
                        ...
                        <div class="row">
                            ...
                            <my-modal
                                modal-title="Sposta in una nuova Famiglia"
                                button-title="Sposta"
                            ...
                            >
                                <template slot="modal-body-slot">
                                    <form
                                        class="form"
                                        method="POST"
                                        id="formFamigliaSposta"
                                        action="{{ route("nomadelfia.personae.famiglie.sposta", ["idPersona" => $persona->id]) }}"
                                    >
                                        {{ csrf_field() }}
                                        @if ($attuale)
                                            <h5 class="my-2">
                                                Completa dati della famiglia
                                                attuale: {{ $attuale->nome }}
                                            </h5>
