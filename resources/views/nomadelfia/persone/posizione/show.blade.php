          ...
          >
            <x-slot:body>
              ...
              >
                ...
                @if ($posattuale != null)
                  <h5 class="my-2">
                    Completa dati della posizione attuale: {{ $posattuale->nome }}
                  </h5>
                  <div class="row">
                    ...
                    <small id="emailHelp" class="form-text text-muted">
                      Lasciare vuoto se concide con la data di inizio della
                      nuova posizione .
                    </small>
                  </div>
                @endif
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <select name="posizione_id" class="form-select">
                      <option value="" selected>
                        ---seleziona posizione---
                      </option>
                      @foreach ($persona->posizioniPossibili() as $posizione)
                        <option value="{{ $posizione->id }}">
                          {{ $posizione->nome }}
                        </option>
                      @endforeach
                    </select>
            ...
            <x-slot:footer>
              <button class="btn btn-success" form="formPersonaPosizione">
                Salva
              </button>
            </x-slot:footer>
          </x-modal>
