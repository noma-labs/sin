        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-warning"
                   href="{{route('nomadelfia.persone.popolazione', ['idPersona'=>$persona->id])}}">Vedi Storico</a>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <textarea class="form-control" id="biografia"
                                              readonly>{{$persona->biografia}}</textarea>
                                    @else
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <a href="{{route('nomadelfia.famiglia.dettaglio',['id'=>$persona->famigliaAttuale()->id])}}">
                                        {{$persona->famigliaAttuale()->nome_famiglia}} </a>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item">
