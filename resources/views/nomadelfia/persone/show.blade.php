                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <span>@if($persona->cf)
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <label class="col-sm-4 font-weight-bold">Biografia:</label>
                                    <div class="col-sm-8">
                        ...
                        @if (! $persona->isDeceduta())
                            <my-modal modal-title="Decesso di persona" button-title="Decesso"
                                ...
                                <template slot="modal-body-slot">
                                    <form class="form" method="POST" id="formDecessoPersona{{$persona->id}}"
                                          action="{{ route('nomadelfia.persone.decesso', ['idPersona' =>$persona->id]) }}">
                                        @csrf
                                        <p> Inserire la data di decesso di {{$persona->nominativo}} </p>
                                        <date-picker :bootstrap-styling="true" format="yyyy-MM-dd"
                                                     name="data_decesso"></date-picker>
                                    </form>
                                </template>
                                <template slot="modal-button">
                                    <button class="btn btn-danger" form="formDecessoPersona{{$persona->id}}">Salva
                                    </button>
                                </template>
                            </my-modal>
                        @endif
                        ...
                        <ul class="list-group list-group-flush">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        @if ($persona->getDataEntrataNomadelfia())
                                            {{$persona->getDataEntrataNomadelfia()}} <span class="badge badge-info">
                                                @diffHumans($persona->getDataEntrataNomadelfia()) </span>
                                        @else
                                            ...
                                            <my-modal modal-title="Uscita dalla comunità" button-title="Uscita"
                                                ...
                                                <template slot="modal-body-slot">
                                                    <form class="form" method="POST"
                                                        ...
                                                        <date-picker :bootstrap-styling="true" format="yyyy-MM-dd"
                                                                     name="data_uscita"></date-picker>

                                                    </form>
                                                </template>
                                                <template slot="modal-button">
                                                    <button class="btn btn-success"
                                                            form="formUscitaPersona{{$persona->id}}">Salva
                                                    </button>
                                                </template>
                                            </my-modal>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a class="btn btn-warning"
                                           href="{{route('nomadelfia.persone.stato', ['idPersona'=>$persona->id])}}">Modifica</a>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a class="btn btn-warning"
                                           href="{{route('nomadelfia.persone.posizione', ['idPersona'=>$persona->id])}}">Modifica</a>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a class="btn btn-warning"
                                           href="{{route('nomadelfia.persone.gruppofamiliare', ['idPersona'=>$persona->id])}}">Modifica</a>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        @forelse ($persona->aziendeAttuali()->get() as $azienda)
                                            <p>
                                                <a href="{{route('nomadelfia.aziende.edit', [$azienda->id])}}">{{ $azienda->nome_azienda }} </a>
                                    ...
                                    <div class="col-sm-2">
                                        <a class="btn btn-warning"
                                           href="{{route('nomadelfia.persone.aziende', ['idPersona'=>$persona->id])}}">Modifica</a>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        @forelse ($persona->incarichiAttuali()->get() as $incarico)
                                            <p>
                                                <a href="{{route('nomadelfia.incarichi.edit', [$incarico->id])}}">{{ $incarico->nome }} </a>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <a class="btn btn-warning"
                                           href="{{route('nomadelfia.persone.famiglie', ['idPersona'=>$persona->id])}}">Modifica</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
