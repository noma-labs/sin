  ...
  <div class="row row-cols-1 row-cols-md-4 g-3">
        ...
        <div class="card-body">
          <ul class="list-group list-group-flush">
            ...
            <li
              class="list-group-item d-flex justify-content-between align-items-center"
            >
              <a href="{{ route("nomadelfia.popolazione.maggiorenni") }}">
                Maggiorenni
              </a>
            ...
            <li
              class="list-group-item d-flex justify-content-between align-items-center"
            >
              <a href="{{ route("nomadelfia.popolazione.posizione.ospiti") }}">
                Ospiti
              </a>
            ...
            <li
              class="list-group-item d-flex justify-content-between align-items-center"
            >
              <a href="{{ route("nomadelfia.popolazione.stati.sacerdoti") }}">
                Sacerdoti
              </a>
              <span class="badge bg-primary rounded-pill">
                {{ count($sacerdoti) }}
    ...
    <div class="col">
      <div class="card h-100">
            ...
            <div class="col-md-6">
              ...
              <ul>
                @foreach ($famiglieNumerose as $fam)
                  <li>
                    <a href="{{ route("nomadelfia.families.show", $fam->id) }}">
                      {{ $fam->nome_famiglia }}
                    </a>
                    <span class="badge bg-primary">
                      {{ $fam->componenti }}
        ...
        <div class="card-footer">
          <a href="{{ route("nomadelfia.families") }}" class="btn btn-primary">
            Entra
          </a>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-footer">
          <a href="{{ route("nomadelfia.activity") }}" class="btn btn-primary">
            Entra
          </a>
        </div>
      </div>
      ...
      >
        ...
        <div class="form-check">
          <input
            ...
            checked
          />
          <label class="form-check-label" for="defaultCheck2"> Famiglie </label>
        </div>
        <div class="form-check">
          <input
            class="form-check-input"
        ...
        <div class="form-check">
          <input
            ...
            checked
          />
          <label class="form-check-label" for="defaultCheck2"> Aziende </label>
        </div>
        <div class="form-check">
          <input
            class="form-check-input"
        ...
        <div class="form-check">
          <input
            ...
            checked
          />
          <label class="form-check-label" for="defaultCheck2"> Scuola </label>
        </div>
      </form>
    </x-slot:body>
    <x-slot:footer>
