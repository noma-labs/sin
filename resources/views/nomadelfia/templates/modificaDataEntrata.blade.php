<my-modal modal-title="Modifica data entrata" button-title="Modifica Entrata" button-style="btn-warning my-1">
        ...
        <form class="form" method="POST" id="formModificaDataEntrata{{$persona->id}}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <small id="help" class="form-text text-muted">Lasciare vuoto se coincide con la data di nascita
                        della persona.</small>
                </div>
            </div>
        </form>
