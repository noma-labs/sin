      ...
      <ul class="mb-0 mt-1">
        @foreach ($allScadute->sortBy("date") as $item)
          <li>
            ...
            — scaduta il {{ $item["date"] }} ({{ abs($item["days"]) }} gg fa)
          </li>
        @endforeach
      </ul>
    </div>
      ...
      <ul class="mb-0 mt-1">
        @foreach ($allInScadenza->sortBy("date") as $item)
          <li>
            ...
            — scade il {{ $item["date"] }} (tra {{ $item["days"] }} gg)
          </li>
        @endforeach
      </ul>
    </div>
  ...
  <form method="POST" action="{{ route("officina.prenota") }}" class="mb-3">
    ...
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-2">
        ...
        <select class="form-select" id="meccanico" name="meccanico" required>
            ...
            <tr scope="row">
              ...
              <td>
                ...
                @elseif ($pren->deveAncoraPartire())
                  <span class="badge bg-warning"> Deve Partire </span>
                @elseif ($pren->isArrivata())
                  <span class="badge bg-success"> Arrivata </span>
                @endif
              </td>
              ...
              <td>
                ...
                @if ($pren->veicolo->deleted_at)
                  <span class="badge bg-danger"> demolito </span>
                @endif
              </td>
