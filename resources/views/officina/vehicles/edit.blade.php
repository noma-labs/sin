...
@section("content")
      ...
      >
        ...
        <div class="row mb-3 g-3">
          ...
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="modello_id" type="text">
          ...
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="tipologia_id" type="text">
          ...
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="impiego_id" type="text">
          ...
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="alimentazione_id" type="text">
        ...
        <div class="row mb-3 g-3">
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="filtro_olio" type="text">
          ...
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="filtro_gasolio" type="text">
              <option value="" hidden selected>--Seleziona--</option>
          ...
          <div class="col-6 col-md-3">
            ...
            <select class="form-select" name="filtro_aria" type="text">
              <option value="" hidden selected>--Seleziona--</option>
          ...
          <ul class="list-group list-group-flush">
            @foreach ($veicolo->gomme()->get() as $gv)
              <li class="list-group-item">
                <div class="row">
                  <div class="col-sm-8">{{ $gv->codice }}</div>
                  <div class="col-sm-4">
                    <form
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <select class="form-select" name="gomma_id">
                      ...
                      @foreach ($gomme as $g)
                        <option value="{{ $g->id }}">{{ $g->codice }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
  ...
  <div class="d-grid gap-3 d-md-block">
    ...
    >
      ...
      <x-slot:footer>
        <button class="btn btn-success" type="submit" form="form-aggiungi-olio">
          Salva
        </button>
      </x-slot:footer>
    </x-modal>
      ...
      >
        <x-slot:body>
          <div class="alert alert-danger" role="alert">
            <p>Attenzione si sta per eliminare il veicolo:
            <strong>{{ $veicolo->nome }}</strong>
            .</p>
            <p>Il veicolo verrà eliminato
            <span class="fst-italic">definitivamente</span>
            e non sarà più possibile recuperarlo.</p>
            <form
        ...
        <x-slot:footer>
          <button type="submit" class="btn btn-success" form="form-elimina">
            Ok
          </button>
        </x-slot:footer>
      </x-modal>
      ...
      >
        <x-slot:body>
          <div class="alert alert-warning" role="alert">
            <p>Attenzione si sta per riabilitare il veicolo:
            <strong>{{ $veicolo->nome }}</strong>
            .</p>
        ...
        <x-slot:footer>
          <button type="submit" class="btn btn-success" form="form-riabilita">
            Ok
          </button>
        </x-slot:footer>
      </x-modal>
    @else
      ...
      >
        <x-slot:body>
          <div class="alert alert-danger" role="alert">
            <p>Attenzione si sta per demolire il veicolo:
            <strong>{{ $veicolo->nome }}</strong>
            .</p>
            <p>Il veicolo verrà comunque conservato come
        ...
        <x-slot:footer>
          <button type="submit" class="btn btn-success" form="form-demolisci">
            Ok
          </button>
        </x-slot:footer>
      </x-modal>
    @endif
    <button class="btn btn-success" form="veicolo-form-modifica" type="submit">
      Salva
    </button>
  </div>
@endsection
