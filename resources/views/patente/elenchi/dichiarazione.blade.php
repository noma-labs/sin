...
<h3 class="text-end py-5">
  ...
  <h3>
    <h3 class="text-start py-5">
      ...
      @endif
      residente in Via Nomadelfia 1, Roselle 58100 Grosseto (GR), in qualità di
      Presidente pro-tempore della Associazione Nomadelfia, con sede in Grosseto
    </h3>

    <h1 class="text-center fw-bold py-5">DICHIARA</h1>

    <h3 class="text-start py-5">
      che le persone sottoelencate appartengono all'associazione e pertanto sono
      autorizzate a condurre gli autoveicoli di proprietà della stessa.
    </h3>
