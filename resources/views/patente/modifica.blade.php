          ...
          <div class="row">
            <div class="col-md-6">
              <label for="data_rilascio_patente">Patente rilasciata il:</label>
                <input type="date" class="form-control" name="data_rilascio_patente" value="{{$patente->data_rilascio_patente }}" />
            </div>
            <div class="col-md-6">
              <label for="rilasciata_dal">Rilasciata da:</label>
                <input type="text" class="form-control" name="rilasciata_dal" value="{{$patente->rilasciata_dal}}"/>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <label for="data_scadenza_patente">Patente valida fino al:</label>
                <input type="date" class="form-control" name="data_scadenza_patente" value="{{$patente->data_scadenza_patente }}"/>
            </div>
            <div class="col-md-6">
              <label for="numero_patente">Numero Patente:</label>
              <input type="text" class="form-control" name="numero_patente" value="{{$patente->numero_patente}}"/>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-md-12">
              <label for="note">Note:</label>
              <textarea class="form-control" name="note"> {{$patente->note}} </textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="assegnaCommissione" id="ycommissione" {{$patente->hasCommissione() ? 'checked' : ''}} />
            ...
            <div class="col-md-5">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button class="btn btn-warning mt-3"> Aggiungi </button>
                </div>
              </div>
            </div>
            <div class="col-md-7">
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <b>{{$c->categoria}} </b>
                        <span class="badge badge-success" > {{$c->pivot->data_rilascio}} </span>
                        <span class="badge badge-danger"> {{$c->pivot->data_scadenza}} </span>
                    </div>
                  @endforeach
