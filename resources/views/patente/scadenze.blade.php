  ...
  <div class="row row-cols-1 row-cols-md-3 g-3 mb-3">
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-body">
          <h5 class="card-title">
            In scadenza entro {{ config("patente.scadenze.patenti.inscadenza") }} gg
            ({{ $patenti->count() }})
          </h5>
          <ul>
            @foreach ($patenti as $patente)
              <li>
                ...
                <span class="badge bg-warning">
                  {{ $patente->data_scadenza_patente }} ({{ Carbon::now()->diffInDays(Carbon::parse($patente->data_scadenza_patente)) }}gg)
                </span>
              </li>
            @endforeach
          </ul>
    ...
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-body">
          <h5 class="card-title">
            In scadenza entro {{ config("patente.scadenze.commissione.inscadenza") }} gg
            ({{ $patentiCommissione->count() }})
          </h5>
          <ul>
              ...
              <ul>
                @foreach ($patentiCQCPersone as $patente)
                  <li>
                    ...
                    <span class="badge bg-warning">
                      {{ $patente->pivot->data_scadenza }} ({{ Carbon::now()->diffInDays(Carbon::parse($patente->pivot->data_scadenza)) }}gg)
                    </span>
                  </li>
                @endforeach
              </ul>
