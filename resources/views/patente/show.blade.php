    ...
    <div class="col-md-6">
      ...
      >
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <label class="form-label" for="luogo_nascita">
              Luogo di nascita:
            </label>
          ...
          <div class="col-md-6">
            <label class="form-label" for="rilasciata_dal">
              Rilasciata da:
            </label>
            <input
              type="text"
          ...
          <div class="col-md-6">
            <label class="form-label" for="numero_patente">
              Numero Patente:
            </label>
            <input
              type="text"
    ...
    <div class="col-md-3 d-flex align-items-center">
      ...
      >
        ...
        <button
          ...
          onclick="
            return confirm('Sei sicuro di voler eliminare questa patente?');
          "
        >
          Elimina
        </button>
