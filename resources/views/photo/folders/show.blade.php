  ...
  <nav aria-label="Percorso" class="mb-2">
    <ol class="breadcrumb mb-0">
      ...
      @foreach ($segments as $i => $seg)
        ...
        @else
          <li class="breadcrumb-item active" aria-current="page">{{ $seg }}</li>
        @endif
      @endforeach
    </ol>
  </nav>
            ...
            <div class="card h-100 shadow-sm">
              ...
              @else
                <div
                  ...
                  style="height: 140px"
                >
                  <span class="text-muted"> Nessuna anteprima </span>
                </div>
              @endif
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  <h6 class="card-title mb-0">{{ $folderLabel }}</h6>
              ...
              <tbody>
                @foreach ($photos as $photo)
                  <tr>
                    ...
                    <td class="fw-semibold">{{ $photo->file_name ?? "—" }}</td>
