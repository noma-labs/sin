          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <dl class="row mb-2">
                ...
                <dd class="col-sm-7">
                  <small class="text-muted"> {{ $issue->source_file }} </small>
                </dd>
                ...
                @if ($issue->location)
                  ...
                  <dd class="col-sm-7">{{ $issue->location }}</dd>
                @endif
                ...
                <dl class="row mb-3">
                  ...
                  <dd class="col-sm-7">
                    <a
                      ...
                      class="text-decoration-none"
                    >
                      {{ $issue->photo_persona_name }} ({{ $issue->nome }} {{ $issue->cognome }})
                    </a>
                  </dd>
                ...
                >
                  <x-slot:body>
                    ...
                    >
                      @csrf
                      <div class="mb-3">
                        <label for="note_{{ $issue->id }}" class="form-label">
                          Nota (opzionale)
                        </label>
                        <textarea
                          class="form-control"
