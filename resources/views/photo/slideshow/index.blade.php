      ...
      <div class="carousel-inner">
        @foreach ($photos as $index => $photo)
          <div class="carousel-item @if($index == 0) active @endif text-center">
            <div class="d-flex flex-column mt-2" style="min-height: 100vh">
              <img
              ...
              />
              <div class="d-inline-block bg-body-secondary rounded p-2 mx-3">
                @if ($photo->taken_at)
                ...
                @if ($photo->description)
                  <p class="text-black fs-5 m-0">{{ $photo->description }}</p>
                @endif
              </div>
            </div>
          </div>
