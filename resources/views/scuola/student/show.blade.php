...
@section("content")
  ...
  <ul class="nav nav-pills pb-3 flex-column flex-sm-row justify-content-center">
    <a
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">
          <div class="row">
            <label class="form-label col-sm-4 fw-bold"> Codice Fiscale: </label>
            <div class="col-sm-8">
              <span>
                @if ($student->cf)
                  {{ $student->cf }}
        ...
        <li class="list-group-item">
          <div class="row">
            <label class="form-label col-sm-4 fw-bold"> Data Nascita: </label>
            <div class="col-sm-8">
              <span> {{ $student->data_nascita }} </span>
            </div>
          </div>
        </li>
        <li class="list-group-item">
