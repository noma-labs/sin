    ...
    **/
    public function spostaInGruppoFamiliare(Request $request, $id, $currentGruppo)
    {
      ...
      'data_cambiogruppo.required'=>"La data del cambio di gruppo è obbligatoria.",
        ...
        if (count($gruppo_corrente) == 1) {
            $famiglia->assegnaFamigliaANuovoGruppoFamiliare($gruppo_corrente[0]->id, $request->data_cambiogruppo, $request->nuovo_gruppo_id, $request->data_cambiogruppo);
    ...
    public function uscita(Request $request, $id)
    {
      ...
      'data_uscita.date'=>"La data di uscita non è una data corretta.",
        ...
        return redirect(route('nomadelfia.famiglia.dettaglio', ['id'=>$id]))->withSuccess("Famiglia uscita con successo.");
    }
}
