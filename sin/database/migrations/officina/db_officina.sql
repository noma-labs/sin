...
--
-- Host: 127.0.0.1
-- Creato il: Dic 11, 2021 alle 16:19
...
CREATE TABLE `libretto_circolazione` (
...
CREATE TABLE `tipo_manutenzione` (
  `id` int(10) UNSIGNED NOT NULL,
...
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_clienti_meccanica` (
`id` int(10)
,`nominativo` varchar(100)
,`data_nascita` date
...
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_lavoratori_meccanica` (
`azienda_id` int(10)
,`persona_id` int(10)
,`nominativo` varchar(100)
