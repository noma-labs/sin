CREATE TABLE `anno`
(
    `id`          varchar(10) NOT NULL PRIMARY KEY COMMENT 'id anno scolastico',
...
(
    ...
    `anno_id`    varchar(10) NOT NULL COMMENT 'Anno scolastico di riferimento',
    `created_at` timestamp   NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` timestamp   NULL DEFAULT NULL,
...
ALTER TABLE `alunni_classi`
    ADD FOREIGN KEY (`classe_id`) REFERENCES `tipo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
