    ...
    <div class="row">
      <div class="col-md-2">
         <div class="form-group">
          ...
          <input type="date" class="form-control" id="data_par" name="data_par" v-model="data_partenza"  required>
         </div>
      </div>
      <div class="col-md-2">
         <div class="form-group">
          <label for="ora_par">Ora Partenza</label>
          <input type="time" class="form-control" id="ora_par" name="ora_par"  v-model="ora_partenza"  required>
         </div>
      </div>
      <div class="col-md-2">
         <div class="form-group">
          <label for="data_arr">Data Arrivo</label>
          <input type="date" class="form-control" id="data_arr" name="data_arr" v-model="data_arrivo" required>
         </div>
      </div>
      <div class="col-md-2">
         <div class="form-group">
          <label for="ora_arr">Ora Arrivo</label>
          <input  type="time" class="form-control" id="ora_arr" name="ora_arr" v-model="ora_arrivo" required>
         </div>
      </div>
       <div class="col-md-4">
          <div class="form-group">
           ...
           <select class="form-control"  name="veicolo">
            <option selected disabled hidden>--Seleziona veicolo--</option>
             <optgroup v-for="tipologia in veicoli_per_impiegotipologia" :label="tipologia.impiego_tipologia + ' ('+ tipologia.count +')'">
               <option  :selected="veicolo.id == veicolo_selected"  v-for="veicolo in tipologia.veicoli" v-bind:value="veicolo.id" :disabled="hasPrenotazioni(veicolo)"  v-bind:class="{'text-danger': hasPrenotazioni(veicolo) }">
                 {{ veicolo.nome}}
