  ...
  <div>
    <div class="form-group row">
      <div class="form-group col-md-3">
        ...
        <input v-model.trim="form.name" @input="$v.form.name.$touch()" type="text" class="form-control"
               v-bind:class="{ 'is-invalid': $v.form.name.$invalid && $v.form.name.$dirty}"
               placeholder="Nome Veicolo..." name="nome">
        <div class="invalid-feedback" v-if="!$v.form.name.required">Il nome del veicolo è obbligatorio</div>
      </div>
      <div class="form-group col-md-3">
        <label for="targa">Targa</label>
        <input v-model.trim="form.targa" type="text" class="form-control" placeholder="Targa Veicolo" name="targa"
               @input="$v.form.targa.$touch()"
               v-bind:class="{ 'is-invalid': $v.form.targa.$invalid && $v.form.targa.$dirty}">
      ...
      <div class="form-goup col-md-3">
        ...
        <input v-model.trim="form.modello" @input="$v.form.modello.$touch()" type="text" class="form-control"
               v-bind:class="{ 'is-invalid': $v.form.modello.$invalid && $v.form.modello.$dirty}"
               placeholder="Es. Doblò, Marea..." name="modello">
    ...
    <div class="form-group row">
      ...
      <div class="form-goup col-md-3">
        ...
        <input type="number" v-model.trim="form.posti" class="form-control"
               v-bind:class="{ 'is-invalid': $v.form.posti.$invalid &&  $v.form.posti.$dirty}"
               @input="$v.form.posti.$touch()" name="posti">
    ...
    <button class="btn btn-primary" name="_addanother" v-bind:disabled="$v.form.$invalid" value="true" type="submit">
      Salva e aggiungi un'altro veicolo
    </button>
