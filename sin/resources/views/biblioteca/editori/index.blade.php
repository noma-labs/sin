...
<div class="my-page-title">
    ...
    <div class="mr-auto p-2"><span class="h1 text-center">Gestione Editori </span></div>
  ...
  <div class="col-md-8 offset-md-2 my-3">
    <span>Ricerca editore:</span>
      <form action="{{route('editori.ricerca')}}" method="get">
        {{ csrf_field() }}
        <autocomplete placeholder="Inserisci editore ..." name="idEditore" url={{route('api.biblioteca.editori')}}></autocomplete>
        <button  class="btn btn-success my-2 float-right"  type="submit">Cerca </button>
      </form>
  </div>
</div>
