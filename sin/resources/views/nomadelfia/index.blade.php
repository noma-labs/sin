...
@section('navbar-link')
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarPopolazione">
            <a class="dropdown-item" href="{{route('nomadelfia.popolazione')}}"> Popolazione</a>
            <a class="dropdown-item" href="{{route('nomadelfia.popolazione.maggiorenni')}}"> Maggiorenni</a>
            ...
            <a class="dropdown-item" href="{{route('nomadelfia.popolazione.posizione.figli.maggiorenni')}}">Figli
                Mag.</a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('nomadelfia.incarichi.index') }}">Incarichi</a>
    </li>
    <li class="nav-item">
