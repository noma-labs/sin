...
@section("archivio")
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">Ricerca
        effettuata:<strong> {{$msgSearch}}</strong>
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    </div>

    <div id="results" class="alert alert-success"> Numero di persone trovate: <strong> {{ $persone->total() }} </strong>
    </div>
