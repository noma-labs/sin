...
<div class="row justify-content-md-center">
    <div class="col-md-12">
      <div class="card my-2">
        <div class="card-body">
          <h3>Nomadelfi Effettivi <span class="badge badge-primary"> {{$effettivi->total}}</span></h3>
         </div> 
       </div> 
    </div> 
</div>
...
<div class="row justify-content-center">
    <div class="col-sm-6">
        <div class="card">
            <div class="card-header">
              <h5>Uomini <span class="badge badge-primary"> {{count($effettivi->uomini)}}</span></h5>
            </div>
            <div class="card-body">
              <div class="row">
              ...
              @empty
              <p class="text-danger">Nessun effettivo</p>
              @endforelse
            </div>  <!--end card body-->
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-header">
              <h5>Donne <span class="badge badge-primary"> {{count($effettivi->donne)}}</span></h5>
            </div>
            <div class="card-body">
              <div class="row">
                <p class="col-md-3 font-weight-bold"> Nominativo</p>
