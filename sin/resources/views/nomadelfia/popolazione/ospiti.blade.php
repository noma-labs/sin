...
<div class="row justify-content-md-center">
    <div class="col-md-12">
      <div class="card my-2">
        <div class="card-body">
          <h3>Ospiti <span class="badge badge-primary"> {{$ospiti->total}}</span></h3>
         </div> 
       </div> 
    </div> 
</div>
...
<div class="row justify-content-center">
    <div class="col-sm-6">
        <div class="card">
            <div class="card-header">
              <h5>Uomini <span class="badge badge-primary"> {{count($ospiti->uomini)}}</span></h5>
            </div>
            <div class="card-body">
              <div class="row">
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-header">
              <h5>Donne <span class="badge badge-primary"> {{count($ospiti->donne)}}</span></h5>
            </div>
            <div class="card-body">
              <div class="row">
                <p class="col-md-4 font-weight-bold"> Nominativo</p>
