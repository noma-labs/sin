...
@section('title', 'Gestione Postulanti')
...
<div class="row justify-content-center">
    <div class="col-sm-9">
       Nomadelfi Postulanti <span class="badge badge-primary"> {{$count}}</span>
      <div class="row">
        <div class="col-8 col-sm-6">
            <div class="card">
                <div class="card-header">
                  Nomadelfia Postulanti Uomini <span class="badge badge-primary">  {{count($uomini)}} </span>
                </div>
                <div class="card-body">
                  <div class="row">
        ...
        <div class="col-4 col-sm-6">
            <div class="card">
                <div class="card-header">
                  Nomadelfia Postulanti Donne <span class="badge badge-primary">  {{count($donne)}} </span>
                </div>
                <div class="card-body">
                  <div class="row">
                    <p class="col-md-3 font-weight-bold"> Nominativo</p>
