...
{{--              </select>--}}
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" name="filtro_olio" type="text">
                <option value="" hidden selected>--Seleziona--</option>
              @foreach ($f_olio as $filtro)
                <option value="{{ $filtro->id }}" @if($filtro->id == $veicolo->filtro_olio) selected @endif>{{ $filtro->codice }}</option>
              @endforeach
            </select>
           </div>
         </div>
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" name="filtro_gasolio" type="text">
                <option value="" hidden selected>--Seleziona--</option>
              @foreach ($f_gasolio as $filtro)
                <option value="{{ $filtro->id }}" @if($filtro->id == $veicolo->filtro_gasolio) selected @endif>{{ $filtro->codice }}</option>
              @endforeach
            </select>
           </div>
         </div>
         ...
         <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" name="filtro_aria" type="text">
                <option value="" hidden selected>--Seleziona--</option>
              @foreach ($f_aria as $filtro)
                <option value="{{ $filtro->id }}" @if($filtro->id == $veicolo->filtro_aria) selected @endif>{{ $filtro->codice }}</option>
              @endforeach
            </select>
           </div>
         </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="filtro_aria_condizionata" type="text">
                <option value="" hidden selected>--Seleziona--</option>
              @foreach ($f_ac as $filtro)
                <option value="{{ $filtro->id }}" @if($filtro->id == $veicolo->filtro_aria_condizionata) selected @endif>{{ $filtro->codice }}</option>
              @endforeach
            </select>
           </div>
         </div>
        ...
        <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="olio_id" type="text">
                      ...
                      @foreach ($olio_motore as $o)
                        <option value="{{ $o->id }}" @if($o->id == $veicolo->olio_id) selected @endif>{{ $o->codice }}</option>
                      @endforeach
                  </select>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="number" name='litri_olio' class="form-control" @if($veicolo->litri_olio) value="{{$veicolo->litri_olio}}" @endif>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3">
        <gomme-veicolo v-bind:gomme="{{$veicolo->gomme}}" v-bind:veicolo="{{$veicolo->id}}" token="{{ csrf_token() }}" >
        </gomme-veicolo>
        ...
        <div class="card card-mod" >
            ...
            <div class="card-body card-body-mod">
                ...
                <my-modal modal-title="Aggiungi File" button-title="Aggiungi File" button-style="btn-block btn-warning"> 
                    <template v-slot:modal-body-slot>
                      <form action="#" method="post" id="form-aggiungi-file">
                          {{ csrf_field() }}
                          <input type="hidden" name="veicolo" value="{{$veicolo->id}}">
                          <input type="file" name="file" class="form-control file-input" id="file">
                          <label for="file" class="file-label btn btn-warning">Scegli File <i class="fa fa-upload" aria-hidden="true"></i></label>
                      </form>
                    </template>
...
<div class="row">
<div class="col-md-2">
<my-modal modal-title="Aggiungi Filtro" button-title="Aggiungi Filtro" button-style="btn-block btn-warning">
    <template v-slot:modal-body-slot>
        <form method="POST" action="{{route('filtri.aggiungi')}}" id="form-aggiungi-filtro">
            {{ csrf_field() }}
            <input type="hidden" name="veicolo" value="{{$veicolo->id}}">
            <div class="row">
                <div class="col-md-4">
                      <label for="codice">Codice Filtro</label>
                      <input name="codice" type="text" id="codice" class="form-control" placeholder="es. S 3259">
                </div>
                <div class="col-md-4">
                      ...
                      <select name="tipo" id="tipo" class="form-control">
                        ...
                        @foreach ($enum_tipo_filtro as $t_filtro)
                            <option value="{{$t_filtro}}">{{$t_filtro}}</option>
                        @endforeach
                      </select>
                </div>
                <div class="col-md-4">
                      <label for="note">Note</label>
                      <input type="text" name="note" id="note" class="form-control" value="" placeholder="Nota Facoltativa...">
                </div>
            </div>
        </form>
    </template>
    <template v-slot:modal-button>
        <button class="btn btn-success" type="submit" form="form-aggiungi-filtro">Salva</button>
    </template>
</my-modal>
</div>
{{-- modal aggiungi tipo olio --}}
<div class="col-md-2">
<my-modal modal-title="Aggiungi Tipo Olio" button-title="Aggiungi Olio" button-style="btn-block btn-warning">
    <template v-slot:modal-body-slot>
        <form method="POST" action="{{route('olio.aggiungi')}}" id="form-aggiungi-olio">
            {{ csrf_field() }}
            <input type="hidden" name="veicolo" value="{{$veicolo->id}}">
            <div class="row">
                <div class="col-md-6">
                      <label for="codice">Codice Olio</label>
                      <input name="codice" type="text" id="codice" class="form-control" placeholder="es. 15W/40">
                </div>
                <div class="col-md-6">
                      <label for="note">Note</label>
                      <input type="text" name="note" id="note" class="form-control" value="" placeholder="Nota Facoltativa...">
    ...
    <template v-slot:modal-button>
        <button class="btn btn-success" type="submit" form="form-aggiungi-olio">Salva</button>
    </template>
</my-modal>
</div>
