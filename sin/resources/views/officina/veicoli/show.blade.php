    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" @if($veicolo->filtroOlio) value="{{$veicolo->filtroOlio->codice}}" @endif disabled>
         </div>
       </div>
      <div class="col-md-3">
        <div class="form-group">
            <label for="impiego">Filtro Gasolio</label>
            <input type="text" class="form-control" @if($veicolo->filtroGasolio) value="{{$veicolo->filtroGasolio->codice}}" @endif disabled>
           </div>
         </div>
       ...
       <div class="col-md-3">
         <div class="form-group">
           ...
           <input type="text" class="form-control" @if($veicolo->filtroAria) value="{{$veicolo->filtroAria->codice}}" @endif disabled>
         </div>
       </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="posti">Filtro A.C.</label>
            <input type="text" class="form-control" @if($veicolo->filtroAriaCondizionata) value="{{$veicolo->filtroAriaCondizionata->codice}}" @endif disabled>
           </div>
         </div>
      ...
      <div class="row">
          <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" @if($veicolo->olioMotore) value="{{$veicolo->olioMotore->codice}}" @endif disabled>
              </div>
          </div>
          ...
          <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" class="form-control" @if($veicolo->litri_olio) value="{{$veicolo->litri_olio}}" @endif disabled>
              </div>
          </div>
      </div>
