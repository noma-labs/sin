...
<form class="container-fluid" id="needs-validation" method="POST" action="{{ route('patente.modifica.conferma', $record->first()->numero_patente) }}">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="data_nascita_persona_patente" name="data_nascita_persona_patente" value="{{ $record->first()->data_nascita_persona_patente }}">
  </div>
  <div class="form-group">
    <label for="luogo_nascita_persona_patente">Luogo di nascita:</label>
    <input type="text" class="form-control" id="luogo_nascita_persona_patente" name="luogo_nascita_persona_patente" value="{{ $record->first()->luogo_nascita_persona_patente }}">
  </div>
  <div class="form-group">
    <label for="rilascio_pantente">Rilascio:</label>
    <input type="text" class="form-control" id="rilascio_pantente" name="rilascio_pantente" value="{{ $record->first()->rilascio_pantente }}">
  </div>
  <div class="form-group">
    <label for="data_inizio_patente">Data inizio patente:</label>
    <input type="text" class="form-control" id="data_inizio_patente" name="data_inizio_patente" value="{{ $record->first()->data_inizio_patente }}">
  </div>
  <div class="form-group">
