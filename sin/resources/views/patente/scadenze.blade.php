    ...
    <div class="col align-self-center">
        <div class="card-deck">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">In scadenza entro {{config('patente.scadenze.patenti.inscadenza')}} gg
                        ({{$patenti->count()}})</h5>
                    <ul>
                        @foreach($patenti as $patente)
                        <li>
                            <a href="{{route('patente.modifica',['id'=>$patente->numero_patente])}}">{{
                                $patente->persona->nominativo }} </a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">In scadenza entro {{config('patente.scadenze.commissione.inscadenza')}} gg
                        ({{$patentiCommissione->count()}})</h5>
                    <ul>
...
<table class="mt-2 table table-hover table-bordered table-sm" style="table-layout:auto;overflow-x:scroll;">
    ...
    <tr>
        ...
        <th style="width: 10%"> {{ App\Traits\SortableTrait::link_to_sorting_action('numero_patente',"Num. Patente")
            }}
        </th>
        <th style="width: 15%"> {{ App\Traits\SortableTrait::link_to_sorting_action('numero_patente',"Data Scadenza")
            }}
        </th>
