...
<form method="GET" action="{{route('patente.ricerca.conferma')}}">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            ...
            <input class="form-control" id="numero_patente" name="numero_patente"
...
@if(!empty($msgSearch))
<div class="alert alert-warning alert-dismissible fade show" role="alert">Ricerca effettuata:<strong>
        {{$msgSearch}}</strong>
...
@if(!empty($patenti))
<div id="results" class="alert alert-success"> Numero di patenti trovate: <strong> {{ $patenti->total() }} </strong>
</div>
...
<div class="table-responsive">
    <table class="table table-hover table-bordered table-sm" style="table-layout:auto;overflow-x:scroll;">
        ...
        <tr>
            ...
            <th style="width: 10%"> {{ App\Traits\SortableTrait::link_to_sorting_action('numero_patente',"N. Patente")
                }}
            </th>
            <th style="width: 10%"> {{ App\Traits\SortableTrait::link_to_sorting_action('numero_patente',"Data
                Scadenza") }}
            </th>
            ...
            <td>
                <div class='btn-group' role='group' aria-label="Basic example">
                    ...
                    <a class="btn btn-warning"
                       href="{{ route('patente.modifica', $patente->numero_patente) }}">Modifica</a>
                    @endcan
...
<div class="modal fade" id="eliminaModal" tabindex="-1" role="dialog" aria-labelledby="modalEliminaPatente"
     aria-hidden="true">
