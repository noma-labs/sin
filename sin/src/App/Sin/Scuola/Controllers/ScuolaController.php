...
//        $superiore = $phpWord->addSection($section);
//        $superiore->addTitle("AAAA", 1);
//        $superiore->addText('aaaa');
//        $superiore->addText('aaaa');
//        $superiore->addText('aaaa');
//        $superiore->addText('aaaa');
//
//        $superiore = $phpWord->addSection($section);
//        $superiore->addTitle('BBB', 1);
//        $superiore->addText('bbbb');
//        $superiore->addText('bbbb');
//        $superiore->addText('bbbb');
//        $superiore->addText('bbbb');
//
//        $superiore = $phpWord->addSection($section);
//        $superiore->addTitle('CCC', 1);
//        $superiore->addText('cccc');
//        $superiore->addText('cccc');
//        $superiore->addText('cccc');
//        $superiore->addText('cccc');
